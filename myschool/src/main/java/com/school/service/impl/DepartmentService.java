...
public class DepartmentService implements BaseService<Department>{
	...
	public List<Department> selectByDepartmentExample(DepartmentExample example){
		return departmentMapper.selectByExample(example);
	}
	
//	查询所有部门下的人及其部门
	public List<DepAndEmp> findTotal(){
		PageHelper.startPage(PaginationContext.getPageNum(), 
				 PaginationContext.getPageSize());
...
//	根据部门名字查询该部门是否存在
	public int exist(String depName){
		return departmentMapper.exist(depName);
	}
}
